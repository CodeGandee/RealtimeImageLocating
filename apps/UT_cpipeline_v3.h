...
int main() {
    ...
    IMGRGLOC_Image2Map_set_map(image2map_pipe, cvc_map);
    ...
    for (;;)
    {
        ...
        IMGRGLOC_Image2Map_set_query_image(image2map_pipe, cvc_image);
        ...
        string save_filename = "E:/projects/MapMatching/data/output/ori_images/" + to_string(count) + ".jpg";
