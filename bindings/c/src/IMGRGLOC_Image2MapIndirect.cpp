...
using Image2MapIndirect = rloc::pipeline::Image2MapIndirect;
...
IMGRGLOC_ErrorCode IMGRGLOC_Image2MapIndirect_create(IMGRGLOC_Image2MapIndirect** obj) {
	auto _obj = new Image2MapIndirect();
	*obj = (IMGRGLOC_Image2MapIndirect*)_obj;
	return IMGRGLOC_ERR_NONE;
}

IMGRGLOC_ErrorCode IMGRGLOC_Image2MapIndirect_destroy(IMGRGLOC_Image2MapIndirect* obj) {
	delete (Image2MapIndirect*)obj;
	return IMGRGLOC_ERR_NONE;
}
...
{
	auto p = (Image2MapIndirect*)obj;
	p->do_ref_image_keypoint_detection();
	return IMGRGLOC_ERR_NONE;
}
...
{
	auto p = (Image2MapIndirect*)obj;
	p->do_ref_image_feature_extraction();
	return IMGRGLOC_ERR_NONE;
}
...
IMGRGLOC_ErrorCode IMGRGLOC_Image2MapIndirect_get_ref_image_keypoints_2map(IMGRGLOC_Image2MapIndirect* obj, CVCMat out_pts)
{
	...
	auto m = p->get_processed_sift_ref();
...
IMGRGLOC_ErrorCode IMGRGLOC_Image2MapIndirect_get_ref_image_keypoints_2image(IMGRGLOC_Image2MapIndirect* obj, CVCMat out_pts)
{
	auto* p = (Image2MapIndirect*)obj;
	auto& _out_pts = *(cv::Mat*)out_pts;
	auto m = p->get_processed_orb_ref();
...
{
	auto p = (Image2MapIndirect*)obj;
	*out_is_ready = p->is_ref_image2map_ready();
	return IMGRGLOC_ERR_NONE;
}
...
{
	auto p = (Image2MapIndirect*)obj;
	*out_is_ready = p->is_ref_image2query_ready();
	return IMGRGLOC_ERR_NONE;
}
...
{
	auto p = (Image2MapIndirect*)obj;
	*out_is_success = p->do_match_image2map_indirect();
	return IMGRGLOC_ERR_NONE;
}
...
IMGRGLOC_ErrorCode IMGRGLOC_Image2MapIndirect_get_transformed_image_in_map(IMGRGLOC_Image2MapIndirect* obj, CVCMat out_img, int* out_top_left_x, int* out_top_left_y, CVCMat out_mask)
{
	auto p = (Image2MapIndirect*)obj;
